...
Todos los proyectos estaban en Delphi, en 3 versiones distintas, por lo que había que ponerse manos a la obra y tratar con todo el [Código Legacy](https://es.wikipedia.org/wiki/C%C3%B3digo_heredado). Me río de la [refactorización](https://es.wikipedia.org/wiki/Refactorizaci%C3%B3n) que hay que afrontar en algunos proyectos modernos, tenía código de hace más de 20 años entre mis manos dividido en software y bases de datos.
